...
def query_database():
    ...
    for record in records:
        if count % 2 == 0:                                                                           
             my_tree.insert(parent='', index='end', iid=count, text='', values=(record[0],record[1],record[2],record[3],record[4],record[5],record[6],record[7],record[8],record[9],record[10],record[11],record[12],record[13],record[14],record[15],record[16],record[17],record[18],record[19],record[20],record[21]), tags=('evenrow',))
        else:
            my_tree.insert(parent='', index='end', iid=count, text='', values=(record[0],record[1],record[2],record[3],record[4],record[5],record[6],record[7],record[8],record[9],record[10],record[11],record[12],record[13],record[14],record[15],record[16],record[17],record[18],record[19],record[20],record[21]), tags=('oddrow',))
...
my_tree['columns']=("ID", "CPF CNPJ", "Razão Social", "Nome Fantasia", "Gerente", "Franqueado", "C.Franqueado", "Captador", "C.Captador", "Diretor", "Status", "Situação", "Email", "Celular", "Mídia","Data 1º contato", "Data de Ativação", "Data Comitê", "Id-Sales Force", "Faturamento", "Tipo de operação", "Desenho operacional")
...
CNPJ_label = Label(data_frame, text="CPF CNPJ")
...
Razao_label = Label(data_frame, text="Razão Social")
...
nomef_label = Label(data_frame, text="Nome Fantasia")
...
gerente_label = Label(data_frame, text="Gerente")
...
franqueado_label = Label(data_frame, text="Franqueado")
...
cf_label = Label(data_frame, text="Comissão Franqueado")
...
captador_label = Label(data_frame, text="Captador")
...
cc_label = Label(data_frame, text="C.Captador")
...
diretor_label = Label(data_frame, text="Diretor")
...
situacao_label = Label(data_frame, text="Situacão")
...
celular_label = Label(data_frame, text="Celular")
...
midia_label = Label(data_frame, text="Mídia")
...
data1c_label = Label(data_frame, text="Data 1º contato")
...
DataAtiv_label = Label(data_frame, text="Data de Ativação")
...
DataComite_label = Label(data_frame, text="Data Comitê")
...
IdSf_label = Label(data_frame, text="Id-Sales Force")
...
Faturamento_label = Label(data_frame, text="Faturamento")
...
TipoOp_label = Label(data_frame, text="Tipo de operação")
...
DO_label = Label(data_frame, text="Desenho operacional")
...
def delete_selected():
    ...
    a = "DELETE FROM Cadastros WHERE ID="+ ID_entry.get()
...
def update_record():
    ...
    my_tree.item(selected, text="",values=(ID_entry.get(),CNPJ_entry.get(),Razao_entry.get(),nomef_entry.get(),gerente_entry.get(),franqueado_entry.get(),cf_entry.get(),captador_entry.get(),cc_entry.get(),diretor_entry.get(),status_entry.get(),situacao_entry.get(),email_entry.get(),celular_entry.get(),midia_entry.get(),data1c_entry.get(),DataAtiv_entry.get(),DataComite_entry.get(),IdSf_entry.get(),Faturamento_entry.get(),TipoOP_entry.get(),DO_entry.get(),))
...
def Cadastro():
    ...
    if len(data)==0:
        ...
        py.alert('CNPJ já cadastrado: %s'%CNPJ_entry.get())
...
clear_button = tkinter.Button(button_frame, text="Limpar", command=limpar)
